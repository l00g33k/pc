...
# This script sets up Ubuntu Linux

# Steps:
# 1. Install Ubuntu and enable sshd:
#    sudo apt install net-tools openssh-server git vim
...
function main() {
    ...
    echo -e "${INFO} Line $LINENO: This script will setup the Ubuntu Linux environment. Enter to continue ${RST}"
    fix__wait4user $LINENO
